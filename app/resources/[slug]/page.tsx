      ...
      <div className="article-content py-20 lg:py-32">
        <div className='content-wrapper'>
          <div className="article-wrapper max-w-[980px] mx-auto flex flex-col gap-6">
            ...
            {post.acf.download && (
              <a href={post.acf.download} className='text-white text-sm font-medium py-3 px-6 rounded-full bg-[--primary-colour] self-start' target="_blank">{post.acf.button_label}</a>
            )}
          </div>
        </div>
      </div>
