                  ...
                  <ul className='flex flex-col gap-10'>
                    <li className='programmes-section'>
                      ...
                      <ul className='flex flex-col gap-4 mt-4'>
                        ...
                        <li><a href="/have-a-hmmm" className='text-gray-700 font-light hover:text-[--primary-colour] py-1'>Have a hmmm in the workplace</a></li>
                        ...
                        <li><a href="/work-should-not-hurt/wsnh-injury-dashboard" className='text-gray-700 font-light hover:text-[--primary-colour] py-1'>CHASNZ Claims and Injuries dashboard</a></li>
                      </ul>
                    </li>
                    ...
                    <ul className='flex flex-col gap-10'>
                        <li className='resource-section'>
                          ...
                          <ul className='flex flex-col gap-4 mt-4'>
                            ...
                            <li><a href="/mobile-safety/" className='text-gray-700 font-light hover:text-[--primary-colour] py-1'>Mobile Plant Safety</a></li>
                            <li><a href="/general-resources#resources" className='text-gray-700 font-light hover:text-[--primary-colour] py-1'>Due Diligence in Health and Safety</a></li>
                          </ul>
                        </li>
                ...
                <AccordionContent>
                    ...
                    <ul className='flex flex-col gap-10'>
                        ...
                        <p className='text-lg font-medium'>Events</p>
                          <ul className='flex flex-col gap-4 mt-4'>
                          <li><a href="/events/masterclass-on-contractor-health-and-safety-management-exploration" className='text-gray-700 font-light hover:text-[--primary-colour] py-1'>Masterclass on Contractor Health and Safety Management Exploration</a></li>
