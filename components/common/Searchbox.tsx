...
const Searchbox: React.FC = () => {
  ...
  return (
    <>
      ...
      {isVisible && (
        <>
          <div className="search-box-overlay fixed w-full h-screen bg-black/50 z-40 left-0 bottom-0 backdrop-blur-sm" onClick={() => setIsVisible(false)}></div>
          
          <div className="search-box-container z-50 flex justify-center items-center fixed left-0 right-0 bottom-0 top-0 h-screen w-full">
