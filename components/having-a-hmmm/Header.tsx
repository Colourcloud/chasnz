          ...
          <div className="content-wrapper relative h-full">
              <div className="header-container flex flex-col h-full items-center justify-center gap-6 relative z-10 text-center">
                    ...
                    <div className='flex flex-row items-center gap-4'>
                        <Image src="/having-a-hmmm/wsnh-logo.svg" alt="Work should not hurt logo" width={250} height={250} />
                        <Image src="/having-a-hmmm/acc-logo.svg" alt="Acc logo" width={250} height={250} />
                    </div>
              </div>
            </div>
        </div>
