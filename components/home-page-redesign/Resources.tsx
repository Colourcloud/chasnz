    ...
    <div className="py-16 lg:py-32">
        <div className="site-wrapper">
            <div className="flex flex-col gap-6 text-center">
                <h6 className='text-2xl md:text-4xl lg:text-5xl font-semibold'>Take action and get <span className='text-white bg-[--primary-colour] px-2'>work-site ready</span></h6>
