    ...
    <section className="introduction py-20 lg:py-32">
      <div className="site-wrapper">
        <div className="section-text w-full md:w-3/4 xl:w-3/4 text-center mx-auto flex flex-col gap-4">
          ...
          <p className='text-lg md:text-2xl font-light text-[--dark-blue]'>We provide evidence, robust guidance and tools to help you manage health, safety and well-being in your business - whatever size that is.</p>
        </div>
