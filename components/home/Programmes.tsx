                ...
                <div className="programme-card h-[400px] flex flex-col justify-end relative" id="wsnh-card">
                    ...
                    <div className="card-content">
                        <div className="card-text z-10 relative flex flex-col gap-4">
                            ...
                            <Link href="/work-should-not-hurt/" className='text-white font-semibold flex flex-row items-center gap-2'>Learn More <IoIosArrowDroprightCircle /></Link>
                        </div>
                    </div>
                </div>
                <div className="programme-card h-[400px] flex flex-col justify-end relative" id="totika-card">
                    ...
                    <div className="card-content">
                        <div className="card-text z-10 relative flex flex-col gap-4">
                            ...
                            <Link href="/totika/" className='text-white font-semibold flex flex-row items-center gap-2'>Learn More <IoIosArrowDroprightCircle /></Link>
                        </div>
                    </div>
                </div>
                <div className="programme-card h-[400px] flex flex-col justify-end relative" id="leadon-card">
                    ...
                    <div className="card-content">
                        <div className="card-text z-10 relative flex flex-col gap-4">
                            ...
                            <Link href="/leadon/" className='text-white font-semibold flex flex-row items-center gap-2'>Learn More <IoIosArrowDroprightCircle /></Link>
                        </div>
                    </div>
                </div>
                <div className="programme-card h-[400px] flex flex-col justify-end relative" id="constructsafe-card">
                    ...
                    <div className="card-content">
                        <div className="card-text z-10 relative flex flex-col gap-4">
                            ...
                            <Link href="/constructsafe/" className='text-white font-semibold flex flex-row items-center gap-2'>Learn More <IoIosArrowDroprightCircle /></Link>
                        </div>
                    </div>
                </div>
            </div>
