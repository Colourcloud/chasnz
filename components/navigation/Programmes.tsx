                            ...
                            <div className="mega-menu_right_list mt-10 flex flex-row gap-14 flex-wrap">
                                <div className="mega-menu_right_list_items">
                                    <a href="/work-should-not-hurt">
                                        <Image src="/programmes/logos/wsnh-colour.svg" alt="" width={185} height={50} className='min-h-[50px]' />
                                        {/* <h6 className='text-black font-semibold text-xl underline hover:text-[--primary-colour]'>Work should not hurt</h6> */}
                                    </a>
                                ...
                                <div className="mega-menu_right_list_items">
                                    <a href="/totika">
                                        <Image src="/programmes/logos/totika-colour.svg" alt="" width={175} height={50} className='min-h-[50px]' />
                                    {/* <h6 className='text-black font-semibold text-xl underline hover:text-[--primary-colour]'>Tōtika</h6> */}
                                    </a>
                                    <ul className='text-base flex flex-col gap-4 mt-4'>
                                ...
                                <div className="mega-menu_right_list_items">
                                    <a href="/leadon/">
                                        <Image src="/programmes/logos/leadon-colour.svg" alt="" width={175} height={50} className='min-h-[50px]' />
                                        {/* <h6 className='text-black font-semibold text-xl underline hover:text-[--primary-colour]'>Lead On.</h6> */}
                                    </a>
                                    <ul className='text-base flex flex-col gap-4 mt-4'>
                                ...
                                <div className="mega-menu_right_list_items">
                                    <a href="/constructsafe/">
                                        <Image src="/programmes/logos/constructsafe-colour.svg" alt="" width={175} height={50} className='min-h-[50px]' />
                                        {/* <h6 className='text-black font-semibold text-xl underline hover:text-[--primary-colour]'>ConstructSafe</h6> */}
                                    </a>
                                    <ul className='text-base flex flex-col gap-4 mt-4'>
