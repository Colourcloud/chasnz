        ...
        <div className="content-wrapper">
            <div className="introduction-container flex flex-col lg:flex-row gap-16 lg:gap-0">
                ...
                <div className="programme-text flex flex-col gap-6 w-full lg:w-[70%] ml-0 xl:ml-[8rem] z-[10] lg:mt-[-14rem] lg:bg-white lg:pt-12 lg:px-20">
                    ...
                    <div className="text-block flex flex-col gap-6">
                        <p className='text-[--dark-blue] text-xl lg:text-2xl font-semibold'>The fine print</p>
                    ...
                    <div className="text-block flex flex-col gap-6">
                        <p className='text-[--dark-blue] text-xl lg:text-2xl font-semibold'>For your frontline leader to successfully participate in this trial, they will be:</p>
                    ...
                    <div className="text-block flex flex-col gap-6">
                        <p className='text-[--dark-blue] text-xl lg:text-2xl font-semibold'>Register yourself</p>
                    ...
                    <div className="text-block flex flex-col gap-6">
                        <p className='text-[--dark-blue] text-xl lg:text-2xl font-semibold'>Does this sound like you?</p>
                    ...
                    <div className="text-block flex flex-col gap-6">
                        <p className='text-[--dark-blue]'>Programme run by</p>
