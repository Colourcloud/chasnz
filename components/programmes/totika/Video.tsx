    ...
    <section className="video-section py-20 lg:py-40">
        <div className="site-wrapper">
            <div className="video-text flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                <h4 className='font-bold text-2xl lg:text-3xl w-full lg:w-4/5 text-[--dark-blue]'>Interested in the benefits that the Tōtika scheme can offer your organisation with Health and Safety pre-qualification?</h4>
