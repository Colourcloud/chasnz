            ...
            <div className="introduction-container flex flex-col lg:flex-row gap-16 lg:gap-0">
                <div className="programme-navigation w-full lg:w-[30%]">
                    ...
                    <ul className='flex flex-col gap-6 underline text-[--primary-colour] mt-6 text-lg'>
                        <li><Link href="#trades">Scaffolding</Link></li>
                        ...
                        <li><Link href="/work-should-not-hurt" className='flex flex-row items-center gap-2'>View More <span><IoIosArrowDroprightCircle /></span></Link></li>
                    </ul>
                </div>
                <div className="programme-text flex flex-col gap-12 w-full lg:w-[70%] ml-0 lg:ml-[11rem]">
                    <div className='flex flex-col gap-6'>
                        <h4 className='font-semibold text-5xl lg:text-7xl'>Building</h4>
