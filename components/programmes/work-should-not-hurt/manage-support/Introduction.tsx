            ...
            <div className="introduction-container flex flex-col lg:flex-row gap-16 lg:gap-0">
                ...
                <div className="programme-text flex flex-col gap-6 w-full lg:w-[70%] ml-0 xl:ml-[8rem] z-[10] lg:mt-[-14rem] lg:bg-white lg:pt-8 lg:px-20">
                    <div className='pb-4 border-b-2'>
                        <div className="trade-stats w-full flex flex-col gap-6 md:flex-row">
                            <div className="trade-stat-container flex flex-col gap-3">
                                <h4 className='text-4xl lg:text-5xl font-semibold text-[--primary-colour] border-b-2 border-[--primary-colour] p-1'>70-80%</h4>
                                <p className='text-[--text-colour]'>Office and support tasks are sedentary</p>
                            </div>
                            <div className="trade-stat-container flex flex-col gap-3">
                    ...
                    <div className='flex flex-col gap-6 mt-[3rem]'>
                        <h4 className='font-semibold text-5xl lg:text-6xl text-[--dark-blue]'>Management &amp; Support</h4>
                        <p className='text-[--text-colour]'>We have worked onsite alongside management and support workers to identify practical solutions to help you reduce the chance of pain and injury. Scroll down to view a wide range of resources to help you work smarter, not harder.</p>
                    </div>
