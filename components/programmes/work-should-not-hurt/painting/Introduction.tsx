                    ...
                    <div className='pb-4 border-b-2'>
                        <div className="trade-stats w-full flex flex-col gap-6 md:flex-row justify-between">
                            <div className="trade-stat-container flex flex-col gap-3">
                                <h4 className='text-4xl lg:text-5xl font-semibold text-[--primary-colour] border-b-2 border-[--primary-colour] p-1'>1,240</h4>
                                <p className='text-[--text-colour]'>250m2 houses not painted</p>
                            </div>
                            <div className="trade-stat-container flex flex-col gap-3">
                                <h4 className='text-4xl lg:text-5xl font-semibold text-[--primary-colour] border-b-2 border-[--primary-colour] p-1'>53</h4>
                                <p className='text-[--text-colour]'>Days off on average per injury</p>
                            </div>
                            <div className="trade-stat-container flex flex-col gap-3">
                                <h4 className='text-4xl lg:text-5xl font-semibold text-[--primary-colour] border-b-2 border-[--primary-colour] p-1'>47,000+</h4>
                                <p className='text-[--text-colour]'>Days off work</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col gap-6 mt-[3rem]'>
                        <h4 className='font-semibold text-5xl lg:text-6xl text-[--dark-blue]'>Painting</h4>
                        <p className='text-[--text-colour]'>We have worked onsite alongside painters to identify practical solutions to help you reduce the chance of pain and injury. Scroll down to view a wide range of resources to help you work smarter, not harder.</p>
                    </div>
