            ...
            <div className="content-wrapper h-full">
              <div className="header-container flex flex-col h-full items-center justify-center gap-10">
                <div className="header-text-block flex flex-col gap-6 text-center w-full lg:w-3/4">
                  ...
                  <p className='text-base md:text-xl font-medium'>The Work Should Not Hurt programme aims to make sure roofers can enjoy long, pain free careers and retire when they want to and not when forced to due to pain and injury.</p>
                </div>
              </div>
            </div>
        </div>
